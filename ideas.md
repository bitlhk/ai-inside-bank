...
<text>
**Design Movement**: 中国银行业数字化设计语言 - 以工行红为核心，融合现代金融科技感

**Core Principles**:
1. 工行红(#C41230)作为品牌主色，AI蓝(#2E6BED)作为智能辅助色
2. 卡片化信息架构，层级清晰
...
理由：
1. 这是一个工行手机银行的Demo，必须忠实于工行品牌视觉体系
2. 用户已提供的HTML原型就是基于工行红+AI蓝的配色方案
